...
LABEL \
    io.hass.name="Ring-MQTT with Video Streaming (Custom version)" \
    io.hass.description="Home Assistant Community Add-on for Ring Devices" \
    io.hass.type="addon" \
    io.hass.version=${BUILD_VERSION} \
    maintainer="Ken Johnson (Github: capnkenny)" \
    org.opencontainers.image.title="Ring-MQTT with Video Streaming (Custom)" \
    org.opencontainers.image.description="Intergrate wtih Ring devices using MQTT/RTSP" \
    org.opencontainers.image.authors="Ken Johnson, Tom Sightler <tsightler@gmail.com> (and various other contributors)" \
    org.opencontainers.image.licenses="MIT" \
    org.opencontainers.image.source="https://github.com/capnkenny/ring-mqtt" \
    org.opencontainers.image.documentation="https://github.com/capnkenny/README.md" \
